    ...
    >
      <div className="mx-auto flex h-[72px] max-w-7xl items-center justify-between px-4 sm:px-6">
        ...
        <div className="hidden items-center gap-2 lg:flex">
          ...
          <Link
            href="/signup"
            className="rounded-full bg-gradient-brand px-5 py-2.5 text-sm font-bold text-white shadow-[0_5px_18px_rgba(115,124,78,0.35)] transition-all hover:scale-[1.03] hover:shadow-[0_8px_24px_rgba(115,124,78,0.45)]"
          >
            Signup
          </Link>
        </div>
